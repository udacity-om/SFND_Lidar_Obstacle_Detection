...
void cityBlock(pcl::visualization::PCLVisualizer::Ptr& viewer)
{
	...
	std::vector<pcl::PointCloud<pcl::PointXYZI>::Ptr> obstClusters = pointProcessor->Clustering(segmentCloud.first, 0.5, 25, 1000);
